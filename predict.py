...
if __name__ == "__main__":
    ...
    # name_classes    = ["Building","Tree","Sky","Car","Sign Symbol","Road","Pedestrian","Fence","Pole","Sidewalk","Bicyclist","Void"]
    name_classes = ["Sky",  "Building", "Pole", "Road", "Pavement","Tree", "SignSymbol", "Fence", "Car","Pedestrian", "Bicyclist", "Unlabelled"]
    # name_classes    = ["background","crack","bubble","MMB"]
    #----------------------------------------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "D:\yyb\data\CamVid\VOCdevkit\VOC2007\JPEGImages"
    dir_save_path   = "D:\yyb\data\CamVid\VOCdevkit\VOC2007\img_outfenge"
    #-------------------------------------------------------------------------#
