...
from module.transMamba import TransMambaBlock  
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, use_transmamba=True):  
    ...
    def forward(self, x):
        ...
        if self.use_transmamba:
            feat5 = self.transmamba(feat5)  # 
        
        return [feat1, feat2, feat3, feat4, feat5]

def resnet50(pretrained=False, use_transmamba=True, **kwargs):  

    model = ResNet(Bottleneck, [3, 4, 6, 3], use_transmamba=use_transmamba, **kwargs)  
